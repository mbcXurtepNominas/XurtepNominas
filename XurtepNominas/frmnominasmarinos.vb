...
Public Class frmnominasmarinos
    ...
    Private Sub calcular()
        ...
        Try
            ...
            For x As Integer = 0 To dtgDatos.Rows.Count - 1
                ...
                dtgDatos.Rows(x).Cells(59).Style.BackColor = Color.White
                dtgDatos.Rows(x).Cells(59).Tag = ""
        ...
        Try
            ...
            If dtgDatos.Rows.Count > 0 Then
                ...
                For x As Integer = 0 To dtgDatos.Rows.Count - 1
                    ...
                    hoja.Cell(filaExcel + x, 35).FormulaA1 = "=(T" & filaExcel + x & "+V" & filaExcel + x & "+Y" & filaExcel + x & "+AF" & filaExcel + x & ")*6%" 'RETENCION 6%"
                    hoja.Cell(filaExcel + x, 36).FormulaA1 = ("=+AG" & filaExcel + x & "+AH" & filaExcel + x & "-AI" & filaExcel + x) 'tOTAL DEPOSITO

                    hoja.Cell(filaExcel + x, 38).FormulaA1 = dtgDatos.Rows(x).Cells(59).Value
                    hoja.Cell(filaExcel + x, 39).FormulaA1 = "30"
                Next x
                ...
                hoja.Cell("C" & sep + 2).Value = "DEPOSITO MARINOS"
                hoja.Cell("C" & sep + 3).Value = "IVA"
                hoja.Cell("C" & sep + 4).Value = "RETENCIÓN 6%"
                hoja.Cell("C" & sep + 5).Value = "TOTAL DEPOSITO MARINOS"
                ...
                hoja.Cell("D" & sep + 7).FormulaA1 = "=P" & filaExcel + total & "+Q" & filaExcel + total & "+U" & filaExcel + total & "+Z" & filaExcel + total
                hoja.Cell("D" & sep + 8).FormulaA1 = "=D" & sep + 7 & "*16%"
                hoja.Cell("D" & sep + 9).FormulaA1 = "=D" & sep + 7 & "+D" & sep + 8

                hoja.Cell("D" & sep + 11).FormulaA1 = "=D" & sep + 45 & "+D" & sep + 9
    ...
    Private Sub calcularcostosocial(ByVal posicion1 As Integer, ByVal dias As Integer)
        ...
        Dim rwCostoSocial As DataRow() = nConsulta(Sql)
        If rwCostoSocial Is Nothing = False Then
            Dim TotalParaISN As Double = Double.Parse(dtgDatos.Rows(posicion1).Cells(33).Value) - Double.Parse(dtgDatos.Rows(posicion1).Cells(22).Value) - Double.Parse(dtgDatos.Rows(posicion1).Cells(23).Value)
            ...
            If dtgDatos.Rows(posicion1).Cells(10).Value >= 55 Then
                ...
                If dtgDatos.Rows(posicion1).Cells(5).Tag = "" Then
                    ...
                    dtgDatos.Rows(posicion1).Cells(58).Value = Math.Round(TotalParaISN * 0.03 + (TotalParaISN * 0.03 * 0.15), 2)
