...
Public Class frmExcel
    ...
    Private Sub tsbGuardar2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbGuardar2.Click
        ...
        Try
            ...
            Ruta = System.Windows.Forms.Application.StartupPath & "\Archivos\marinos1.xlsx"
            Dim tipo As String
            ...
            FileCopy(Ruta, "C:\Temp\Marinos-" & Format(Date.Now, "MMMM yyyy") & "  " & tipo & ".xlsx")
            Documento = MSExcel.Application.Workbooks.Open("C:\Temp\Marinos-" & Format(Date.Now, "MMMM yyyy") & "  " & tipo & ".xlsx")
            ...
            If lsvLista.CheckedItems.Count > 0 Then
                ...
                For Each dato As ListViewItem In lsvLista.CheckedItems
                    ...
                    hoja.Cells(filaExcel, 6).Value = dato.SubItems(44).Text
                    hoja.Cells(filaExcel, 7).Value = dato.SubItems(14).Text
                    hoja.Cells(filaExcel, 8).Value = dato.SubItems(13).Text
                    hoja.Cells(filaExcel, 9).Value = "G0666980109" ''dato.SubItems(8).Text 
                    hoja.Cells(filaExcel, 10).Value = "VER" ''dato.SubItems(9).Text  
                    ...
                    hoja.Cells(filaExcel, 26).Value = dato.SubItems(43).Text  ''dato.SubItems(26).Text
                ...
                For Each dato As ListViewItem In lsvLista.CheckedItems
                    ...
                    hoja2.Cells(filaExcel, 3).Value = dato.SubItems(18).Text
                    hoja2.Cells(filaExcel, 4).Value = ""
                    hoja2.Cells(filaExcel, 5).Value = dato.SubItems(19).Text
                    hoja2.Cells(filaExcel, 6).Value = dato.SubItems(20).Text
                    hoja2.Cells(filaExcel, 7).Value = dato.SubItems(21).Text
                    hoja2.Cells(filaExcel, 8).Value = ""
                    hoja2.Cells(filaExcel, 9).Value = dato.SubItems(22).Text
                    hoja2.Cells(filaExcel, 10).Value = ""
                    hoja2.Cells(filaExcel, 11).Value = dato.SubItems(23).Text
                    ...
                    hoja3.Cells(filaExcel, 5).Value = dato.SubItems(38).Text
                    hoja3.Cells(filaExcel, 6).Value = ""
                    hoja3.Cells(filaExcel, 7).Value = ""
                    hoja3.Cells(filaExcel, 8).Value = dato.SubItems(32).Text
                    hoja3.Cells(filaExcel, 9).Value = dato.SubItems(37).Text
                    hoja3.Cells(filaExcel, 10).Value = dato.SubItems(36).Text
                    hoja3.Cells(filaExcel, 11).Value = dato.SubItems(35).Text
                    hoja3.Cells(filaExcel, 12).Value = dato.SubItems(39).Text
