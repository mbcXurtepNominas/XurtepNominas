...
Public Class frmNominaFinalp
    ...
    Private Sub cargarColumnas()
        ...
        lsvLista.Columns.Add("FECHA_DE_NACIMIENTO")
        ...
        lsvLista.Columns.Add("VACACIONES_PAGADAS")
        lsvLista.Columns.Add("BONO_PUNTUALIDAD")
        lsvLista.Columns.Add("BONO_ASISTENCIA")
        lsvLista.Columns.Add("FOMENTO_AL_DEPORTE")
        lsvLista.Columns.Add("BONO_PROCESO")
    ...
    Private Sub tsbBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbBuscar.Click
        ...
        Try
            ...
            SQL = "SELECT * FROM NominaFinalProcesos "
            SQL &= "WHERE iEstatus=1  "
            SQL &= IIf(chkbPeriodos.Checked, " ", " AND fKiIdPeriodo= " & cboperiodo.SelectedValue)
            ...
            If rwFilas Is Nothing = False Then
                For Each Fila In rwFilas
                    ...
                    item.SubItems.Add("" & Fila.Item("EMPLEADO"))
                    ...
                    item.SubItems.Add("" & Fila.Item("FECHA_DE_NACIMIENTO"))
                    ...
                    item.SubItems.Add("" & Fila.Item("VACACIONES_PAGADAS"))
                    item.SubItems.Add("" & Fila.Item("BONO_PUNTUALIDAD"))
                    item.SubItems.Add("" & Fila.Item("BONO_ASISTENCIA"))
                    item.SubItems.Add("" & Fila.Item("FOMENTO_AL_DEPORTE"))
                    item.SubItems.Add("" & Fila.Item("BONO_PROCESO"))
                    ...
                    item.SubItems.Add("" & Fila.Item("ADEUDO_INFONAVIT"))
                    item.SubItems.Add("" & Fila.Item("AJUSTE_INFONAVIT"))
                    item.SubItems.Add("" & Fila.Item("PENSION_ALIMENTICIA"))
                    item.SubItems.Add("" & Fila.Item("PRESTAMO"))
                    item.SubItems.Add("" & Fila.Item("FONACOT"))
                    item.SubItems.Add("" & Fila.Item("TOTAL_DEDUCCIONES"))
                    ...
                    item.SubItems.Add("" & Fila.Item("ISN_CS"))
                    item.SubItems.Add("" & Fila.Item("COSTO_SOCIAL"))
                    item.SubItems.Add("" & Fila.Item("COSTO_SOCIAL_REAL"))
                    item.SubItems.Add("" & Fila.Item("ASIM"))
                    item.SubItems.Add("" & Fila.Item("SUELDO_ORDINARIO"))
                    item.SubItems.Add("" & Fila.Item("SUBSIDIO_GENERADO"))
                    item.SubItems.Add("" & Fila.Item("SUBSIDIO_APLICADO"))
        ...
        Try
            ...
            If resultado = DialogResult.Yes Then
                ...
                If lsvLista.CheckedItems.Count > 0 Then
                    ...
                    SQL2 = "SELECT * FROM NominaFinalProcesos "
                    ...
                    For Each producto As ListViewItem In lsvLista.CheckedItems
                        ...
                        If rwFilas Is Nothing = False Then
                            If rwFilas.Length = 1 Then
                                ...
                                For Each Fila In rwFilas
                                    SQL = "EXEC setNominaFinalProcesosInsertar 0"
                                    ...
                                    SQL &= "," & IIf(producto.SubItems(45).Text = "", 0, producto.SubItems(45).Text)
                                    SQL &= "," & IIf(producto.SubItems(46).Text = "", 0, producto.SubItems(46).Text)
                                    SQL &= "," & IIf(producto.SubItems(47).Text = "", 0, producto.SubItems(47).Text)
                                    SQL &= "," & IIf(producto.SubItems(48).Text = "", 0, producto.SubItems(48).Text)
                                    SQL &= "," & IIf(producto.SubItems(49).Text = "", 0, producto.SubItems(49).Text)
                                    SQL &= "," & IIf(producto.SubItems(50).Text = "", 0, producto.SubItems(50).Text)
                                    SQL &= "," & IIf(producto.SubItems(51).Text = "", 0, producto.SubItems(51).Text)
                                    SQL &= "," & IIf(chkbTodo.Checked, producto.SubItems(52).Text, cboTipoNomina.SelectedIndex)
                                    SQL &= "," & IIf(chkbTodasSeries.Checked, producto.SubItems(53).Text, cboserie.SelectedIndex)
                                    SQL &= "," & IIf(chkbPeriodos.Checked, producto.SubItems(54).Text, cboperiodo.SelectedValue)
                                    SQL &= ",1"
    ...
    Private Sub tsAcumulados_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsAcumulados.Click
       Try
            ...
            SQL = "EXEC acumuladosProcesosFinal " & cboperiodo.SelectedValue
            Dim rwFilas As DataRow() = nConsulta(SQL)
            ...
            dialogo.FileName = "REPORTE ACUMULADOS PROCESOS " & Usuario.Nombre.ToUpper & " - " & iMes.ToUpper & " " & iejercicio
    ...
    Private Sub chkbPeriodos_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkbPeriodos.CheckedChanged
